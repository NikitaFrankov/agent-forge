...
name: forge-analyze
description: |
  Conduct deep codebase analysis with structured report generation.
  Use for security audits, performance analysis, architecture reviews,
  technical debt assessment, or when user asks to analyze/check/review code.
...
- Architecture reviews and design assessment
- Technical debt and code quality evaluation
- Dependency health checks
- User asks to analyze, check, review, or investigate code
...
1. Launch **analysis-researcher agent** (`agent-forge:analysis-researcher`)
...
1. Launch **analysis-synthesizer agent** (`agent-forge:analysis-synthesizer`)
...
1. Launch **analysis-reporter agent** (`agent-forge:analysis-reporter`)
